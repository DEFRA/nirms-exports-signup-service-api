    ...
    public class TradePartiesService : ITradePartiesService
    {
        ...
        private async Task SendSelfServeApplicationAsync(Guid tradePartyId, bool ContactUpdated, bool AuthRepUpdated)
        {
            ...
            try
            {
                ...
                await SendtoServiceBus(selfServeMessagePayload, "sus.remos.update", tradeParty!.Id ,"2");
            }
            catch (Exception ex)
            {
                throw new InvalidOperationException(ex.Message);
        ...
        private async Task SendtoServiceBus(string payload, string subject, Guid tradePartyId, string schemaVersion = "1")
        {
            try
            {
                ...
                message.ApplicationProperties.Add("Status", "Created");
